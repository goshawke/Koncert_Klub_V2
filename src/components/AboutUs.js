...
const AboutUs = () => {
    return (
        <div id="section_about_us">
            ...
            <p>Hey, we’re Connor and Wes, two wild and crazy dudes who live for live music, loud crowds, and making questionable life choices. We’ve been to more shows than we can count (okay, Wes says that’s because we weren’t exactly sober for all of them). Whether it’s catching the next big band or dancing like nobody’s watching (though we hope everyone is), we’re here to document our adventures.
                 Oh, and if you see Wes at a show, he’s probably either vibing to the music or trying to chat up someone in the crowd—ladies, you’ve been warned.
                  Stay tuned for tales of great music, terrible decisions, and everything in between!
            </p>
